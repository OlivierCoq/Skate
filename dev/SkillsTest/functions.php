...
/**
 *
 * Hello 24 Data team! Olivier here. Here's my functions.php file, which houses the functions that emails user submissions to Kimberly. 
 *
 ...
 */
function skills_test_scripts() {
    
        //Enqueing the CSS, WordPress style!
	wp_enqueue_style( '24data-skilltest-style', '/wp-content/themes/SkillsTest/dist/CSS/style.min.css', false );
    
        //Enqueue my custom script:
    wp_enqueue_script( '24data-submit-valid', '/wp-content/themes/SkillsTest/dist/JS/24data-valid.min.js', 'jquery', false, true );
    
        //Localize it so AJAX knows to use wp-admin/admin-ajax.php file OUTSIDE of the wp-content folder:
    wp_localize_script('24data-submit-valid', 'theAjaxData',
     array( 'ajaxurl' => admin_url('admin-ajax.php'), )
  
    );
}
add_action( 'wp_enqueue_scripts', 'skills_test_scripts' );
...
function send_email() {   
    ...
    add_filter( 'wp_mail_content_type', 'wpdocs_set_html_mail_content_type' );
        ...
        if (         //Regex for validation
            ...
            $to = "kimberlys@24datainc.com,tracyq@24datainc.com"; 
				
            $subject = "24 Data Skills Test Lead Form";
            $headers = "From: Olivier Coq\r\n"; 
